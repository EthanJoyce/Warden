 ...
 * Date: 3/26/2015
 * Project: Warden
 * Usage: Part of the zopfli port
 */
public class ZopfliSymbolStats {
  ...
  void getFreqs(ZopfliLzStore store) {
    int[] sLitLens = this.litLens;
    int[] sDists = this.dists;
    System.arraycopy(ZopfliCookie.intZeroes, 0, sLitLens, 0, 288);
    System.arraycopy(ZopfliCookie.intZeroes, 0, sDists, 0, 32);
  ...
  final void copy(final ZopfliSymbolStats source) {
  ...
  final void alloy(final ZopfliSymbolStats ligand) {
